...
Developed with ❤️ using the **Antigravity IDE**.
...
- **Total COM Isolation**: Powered by a custom **STA Worker Pool** to ensure 100% stability during heavy Windows Shell operations.
